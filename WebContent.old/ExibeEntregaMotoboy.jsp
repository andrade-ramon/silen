						                        ...
						                        <c:forEach items="${entregas}" var="entregas">
													<tr>
														<td class="text-center">
															<button type="submit" name="command" class="btn btn-hover-warning ti-pencil-alt add-tooltip" value="AtualizarCliente" onclick="Atualizar(${entregas.idEntrega})"></button>
															<button type="submit" name="command" class="btn btn-hover-danger ti-trash add-tooltip" value="ApagarCliente" onclick="Excluir(${entregas.idEntrega})"></button>
														</td>
														...
														<td>${entregas.dataEnvio}</td>
														<td>${entregas.dataRetirada}</td>
													</tr>
												</c:forEach>
